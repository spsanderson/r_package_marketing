...
- `index.html` — Main landing page showcasing available R packages
- `styles.css` — Shared stylesheet for all marketing pages

## Packages

| Package | Description | CRAN |
|---------|-------------|------|
| [healthyR](https://github.com/spsanderson/healthyR) | Hospital data analysis and visualization | [![CRAN](https://www.r-pkg.org/badges/version/healthyR)](https://cran.r-project.org/package=healthyR) |
| [healthyR.data](https://github.com/spsanderson/healthyR.data) | Data sets for healthyR | [![CRAN](https://www.r-pkg.org/badges/version/healthyR.data)](https://cran.r-project.org/package=healthyR.data) |
...
This site is served via GitHub Pages. Visit the live site at:
**https://spsanderson.github.io/r_package_marketing/**
